...
> Paste URL. Get 3-point summary. Move on.

**AI Productivity / Reading** built with Kotlin and modern Android development standards.
...
- **Core Functionality**: Streamlined tools and workflows for LinkDigest.
